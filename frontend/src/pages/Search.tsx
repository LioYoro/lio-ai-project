    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="flex flex-col items-center w-full px-8 py-16">
        <div className="text-center mb-12 w-full max-w-4xl">
          ...
          <h1 className="text-5xl font-bold text-white mb-4 w-full">Semantic Search</h1>
          <p className="text-slate-400 text-lg w-full">Find documents using natural language queries</p>
        </div>

        <div className="w-full max-w-4xl">
          <Card className="mb-8 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl w-full">
            <div className="p-8 w-full">
              ...
              <p className="text-base text-slate-400 mt-5 flex items-center gap-2 w-full">
                <span>💡</span>
          ...
          <Card className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl w-full">
            <div className="p-8 w-full">
              {error && (
                <div className="bg-red-500/20 border border-red-500/30 text-red-200 rounded-xl p-5 mb-6 backdrop-blur-sm w-full">
              ...
              {!hasSearched && !query && (
                <div className="text-center py-16 w-full">
                  ...
                  <p className="text-slate-500 mt-4 flex items-center justify-center gap-2 text-base w-full">
              ...
              {hasSearched && query && results.length === 0 && !error && (
                <div className="text-center py-16 w-full">
                  ...
                  <p className="text-slate-500 mt-3 text-base w-full">Try a different search query</p>
                </div>
              )}
                  ...
                  <div className="space-y-5 w-full">
                    {results.map((result) => (
                      <div
                        ...
                        className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 w-full"
                      >
                        <div className="flex items-start justify-between w-full">
                          <div className="flex-1">
                            ...
                            {result.raw_text && (
                              <p className="text-base text-slate-400 mb-4 ml-16 w-full">
                        ...
                        <div className="mt-5 ml-16">
                          <div className="h-2.5 bg-slate-700/50 rounded-full overflow-hidden w-full">
                            <div

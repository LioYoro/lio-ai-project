    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="flex flex-col items-center w-full px-8 py-16">
        <div className="text-center mb-12 w-full max-w-4xl">
          <h1 className="text-5xl font-bold text-white mb-4 w-full">Your Documents</h1>
          <p className="text-slate-400 text-lg w-full">Manage and view all your uploaded documents</p>
        </div>

        <div className="w-full max-w-4xl">
          <Card className="mb-10 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl w-full">
            <div className="p-8 w-full">
              <h2 className="text-2xl font-semibold text-white mb-8 flex items-center gap-3 w-full">
                <Upload className="w-6 h-6 text-blue-400" />
                Upload New Document
              </h2>
              
              <div className="border-2 border-dashed border-white/20 rounded-2xl p-10 text-center bg-white/5 w-full">
                ...
                <label htmlFor="file-input" className="cursor-pointer w-full block">
                  ...
                  <p className="text-sm text-slate-500 mt-3 w-full">PDF, JPG, or PNG (max 10MB)</p>
                </label>
                <Button
                  variant="default"
              ...
              <div className="space-y-6 w-full">
                {listDocuments.data.map((doc) => (
                  ...
                  >
                    ...
                    {selectedDoc === doc.id && (
                      <div className="px-6 pb-6 pt-0 mt-2 w-full">
                        <div className="bg-white/5 rounded-2xl p-6 border-t border-white/10 w-full">

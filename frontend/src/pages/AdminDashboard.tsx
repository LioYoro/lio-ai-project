...
const StatCard = ({ title, value, icon: Icon, color, delay }: any) => (
  <div 
    className="group relative overflow-hidden rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl p-8 transition-all hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg">Overview of your document processing system</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-10 text-white shadow-lg shadow-purple-500/20">
          ...
          <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl p-10 text-white shadow-lg shadow-indigo-500/20">
            <div className="flex items-center justify-between">
              <div>
          ...
          <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-10 text-white shadow-lg shadow-amber-500/20">
            <div className="flex items-center justify-between">
              <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
          <Card className="border border-white/20 bg-white/10 backdrop-blur-xl rounded-2xl overflow-hidden">
          ...
          <Card className="border border-white/20 bg-white/10 backdrop-blur-xl rounded-2xl overflow-hidden">
            ...
            <CardContent className="pt-4">
              {usersByMonthData.length > 0 ? (
                ...
                <div h-60="" className="flex items-center justify-center text-slate-500">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <a href="/admin/documents" className="group flex items-center gap-6 p-8 rounded-2xl border-2 border-white/20 bg-white/10 hover:border-blue-400/50 hover:bg-white/20 transition-all">
            ...
            <a href="/admin/audit-logs" className="group flex items-center gap-6 p-8 rounded-2xl border-2 border-white/20 bg-white/10 hover:border-emerald-400/50 hover:bg-white/20 transition-all">
            ...
            <a href="/admin/users" className="group flex items-center gap-6 p-8 rounded-2xl border-2 border-white/20 bg-white/10 hover:border-purple-400/50 hover:bg-white/20 transition-all">

...
const StatCard = ({ title, value, icon: Icon, color, delay }: any) => (
  <div 
    className="group relative overflow-hidden rounded-2xl border border-white/20 bg-white/10 backdrop-blur-xl p-12 transition-all hover:shadow-xl hover:shadow-blue-500/10 hover:-translate-y-1 w-full"
  ...
  >
    ...
    <div className="relative flex items-center justify-between w-full">
      <div>
        ...
        <p className="mt-8 text-6xl font-bold text-white">{value}</p>
      </div>
      <div className="flex h-20 w-20 items-center justify-center rounded-2xl" style={{ backgroundColor: `${color}20` }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full">
              <a href="/admin/documents" className="group flex items-center gap-8 p-12 rounded-2xl border-2 border-white/20 bg-white/10 hover:border-blue-400/50 hover:bg-white/20 transition-all w-full">
                ...
                <div>
                  ...
                  <p className="text-base text-slate-400 mt-3">View and manage all</p>
                </div>
              </a>

              <a href="/admin/audit-logs" className="group flex items-center gap-8 p-12 rounded-2xl border-2 border-white/20 bg-white/10 hover:border-emerald-400/50 hover:bg-white/20 transition-all w-full">
                <div className="h-20 w-20 rounded-2xl bg-emerald-500/30 flex items-center justify-center group-hover:bg-emerald-500/50 transition-colors">
                  <AlertCircle className="h-10 w-10 text-emerald-400" />
                </div>
                <div>
                  <p className="font-semibold text-white text-xl">Audit Logs</p>
                  <p className="text-base text-slate-400 mt-3">Track system activity</p>
                </div>
              </a>

              <a href="/admin/users" className="group flex items-center gap-8 p-12 rounded-2xl border-2 border-white/20 bg-white/10 hover:border-purple-400/50 hover:bg-white/20 transition-all w-full">
                <div className="h-20 w-20 rounded-2xl bg-purple-500/30 flex items-center justify-center group-hover:bg-purple-500/50 transition-colors">
                  <Users className="h-10 w-10 text-purple-400" />
                </div>
                <div>
                  <p className="font-semibold text-white text-xl">Manage Users</p>
                  <p className="text-base text-slate-400 mt-3">View all users and roles</p>
                </div>
              </a>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-14 text-white shadow-lg shadow-purple-500/20 w-full">
              <div className="flex items-center justify-between w-full">
                <div>
                  ...
                  <p className="text-6xl font-bold mt-8">{stats?.users_count || 0}</p>
                </div>
                <Users className="h-16 w-16 text-purple-200" />
              </div>
            </div>

            <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl p-14 text-white shadow-lg shadow-indigo-500/20 w-full">
              <div className="flex items-center justify-between w-full">
                <div>
                  <p className="text-indigo-200 text-base">Today's Uploads</p>
                  <p className="text-6xl font-bold mt-8">{stats?.documents_today || 0}</p>
                </div>
                <Zap className="h-16 w-16 text-indigo-200" />
              </div>
            </div>

            <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-14 text-white shadow-lg shadow-amber-500/20 w-full">
              <div className="flex items-center justify-between w-full">
                <div>
                ...
                <Clock className="h-16 w-16 text-amber-200" />
              </div>
            </div>
          </div>
            ...
            <Card className="border border-white/20 bg-white/10 backdrop-blur-xl rounded-2xl overflow-hidden w-full">
              ...
              <CardContent className="pt-4 w-full">
                {usersByMonthData.length > 0 ? (
                  ...
                  <div className="h-72 flex items-center justify-center text-slate-500 w-full">
